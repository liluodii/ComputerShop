...
public class HpAdapter extends RecyclerView.Adapter<HpAdapter.ViewHolder> {
    ...
    public HpAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new HpAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final HpAdapter.ViewHolder holder, int position) {
        final ComputerTypeData computerTypeData=DesktopRepo.getInstance().getHPData().get(position);
    ...
    public int getItemCount() {
        return DesktopRepo.getInstance().getHPData().size();
    }
