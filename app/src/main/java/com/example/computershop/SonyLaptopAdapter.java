...
public class SonyLaptopAdapter extends RecyclerView.Adapter<SonyLaptopAdapter.ViewHolder> {
    public LayoutInflater inflater;
    public Context context;
    public SonyLaptopAdapter(Context context) {
        this.context=context;
        this.inflater=LayoutInflater.from(context);
    }
    @NonNull
    @Override
    public SonyLaptopAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        final View view = inflater.inflate(R.layout.cardviewcomp,parent,false);
        return new SonyLaptopAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final SonyLaptopAdapter.ViewHolder holder, int position) {
        final ComputerTypeData computerTypeData=DesktopRepo.getInstance().getSonylaptopData().get(position);
    ...
    public int getItemCount() {
        return DesktopRepo.getInstance().getSonylaptopData().size();
    }
