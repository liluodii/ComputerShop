...
public class MicrosoftAdapter extends RecyclerView.Adapter<MicrosoftAdapter.ViewHolder> {
    public LayoutInflater inflater;
    public Context context;
    public MicrosoftAdapter(Context context) {
        this.context=context;
        this.inflater=LayoutInflater.from(context);
    }
    @NonNull
    @Override
    public MicrosoftAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        final View view = inflater.inflate(R.layout.cardviewcomp,parent,false);
        return new MicrosoftAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final MicrosoftAdapter.ViewHolder holder, int position) {
        final ComputerTypeData computerTypeData=DesktopRepo.getInstance().getMicroData().get(position);
    ...
    public int getItemCount() {
        return DesktopRepo.getInstance().getMicroData().size();
    }
