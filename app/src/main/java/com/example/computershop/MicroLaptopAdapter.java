...
public class MicroLaptopAdapter extends RecyclerView.Adapter<MicroLaptopAdapter.ViewHolder> {

    public LayoutInflater inflater;
    public Context context;
    public MicroLaptopAdapter(Context context) {
        this.context=context;
        this.inflater=LayoutInflater.from(context);
    }
    @NonNull
    @Override
    public MicroLaptopAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        final View view = inflater.inflate(R.layout.cardviewcomp,parent,false);
        return new MicroLaptopAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final MicroLaptopAdapter.ViewHolder holder, int position) {
        final ComputerTypeData computerTypeData=DesktopRepo.getInstance().getMicrolaptopData().get(position);
    ...
    public int getItemCount() {
        return DesktopRepo.getInstance().getMicrolaptopData().size();
    }
