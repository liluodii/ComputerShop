...
public class AppleLaptopAdapter extends RecyclerView.Adapter<AppleLaptopAdapter.ViewHolder>{
    public LayoutInflater inflater;
    public Context context;
    public AppleLaptopAdapter(Context context) {
        this.context=context;
        this.inflater=LayoutInflater.from(context);
    }
    @NonNull
    @Override
    public AppleLaptopAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        final View view = inflater.inflate(R.layout.cardviewcomp,parent,false);
        return new AppleLaptopAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final AppleLaptopAdapter.ViewHolder holder, int position) {
        final ComputerTypeData computerTypeData=DesktopRepo.getInstance().getApplelaptopData().get(position);
    ...
    public int getItemCount() {
        return DesktopRepo.getInstance().getApplelaptopData().size();
    }
