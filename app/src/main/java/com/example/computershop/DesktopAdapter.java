...
public class DesktopAdapter extends RecyclerView.Adapter<DesktopAdapter.ViewHolder> {
    ...
    public DesktopAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new DesktopAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final DesktopAdapter.ViewHolder holder, int position) {
        final ComputerTypeData computerTypeData=DesktopRepo.getInstance().getAppleData().get(position);
    ...
    public int getItemCount() {
        return DesktopRepo.getInstance().getAppleData().size();
    }
