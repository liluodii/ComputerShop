...
public class DellAdapter extends RecyclerView.Adapter<DellAdapter.ViewHolder>{
    public LayoutInflater inflater;
    public Context context;
    public DellAdapter(Context context) {
        this.context=context;
        this.inflater=LayoutInflater.from(context);
    }
    @NonNull
    @Override
    public DellAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        final View view = inflater.inflate(R.layout.cardviewcomp,parent,false);
        return new DellAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final DellAdapter.ViewHolder holder, int position) {
        final ComputerTypeData computerTypeData=DesktopRepo.getInstance().getDellData().get(position);
    ...
    public int getItemCount() {
        return DesktopRepo.getInstance().getDellData().size();
    }
