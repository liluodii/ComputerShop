...
public class LenovoLaptopAdapter  extends RecyclerView.Adapter<LenovoLaptopAdapter.ViewHolder>{
    public LayoutInflater inflater;
    public Context context;
    public LenovoLaptopAdapter(Context context) {
        this.context=context;
        this.inflater=LayoutInflater.from(context);
    }
    @NonNull
    @Override
    public LenovoLaptopAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        final View view = inflater.inflate(R.layout.cardviewcomp,parent,false);
        return new LenovoLaptopAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final LenovoLaptopAdapter.ViewHolder holder, int position) {
        final ComputerTypeData computerTypeData=DesktopRepo.getInstance().getLenovolaptopData().get(position);
    ...
    public int getItemCount() {
        return DesktopRepo.getInstance().getLenovolaptopData().size();
    }
