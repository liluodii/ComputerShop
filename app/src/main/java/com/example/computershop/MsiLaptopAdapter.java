...
public class MsiLaptopAdapter extends RecyclerView.Adapter<MsiLaptopAdapter.ViewHolder>{
    public LayoutInflater inflater;
    public Context context;
    public MsiLaptopAdapter(Context context) {
        this.context=context;
        this.inflater=LayoutInflater.from(context);
    }
    @NonNull
    @Override
    public MsiLaptopAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        final View view = inflater.inflate(R.layout.cardviewcomp,parent,false);
        return new MsiLaptopAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final MsiLaptopAdapter.ViewHolder holder, int position) {
        final ComputerTypeData computerTypeData=DesktopRepo.getInstance().getMsilaptopData().get(position);
    ...
    public int getItemCount() {
        return DesktopRepo.getInstance().getMsilaptopData().size();
    }
