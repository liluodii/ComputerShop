...
public class MsiAdapter extends RecyclerView.Adapter<MsiAdapter.ViewHolder>{
    public LayoutInflater inflater;
    public Context context;
    public MsiAdapter(Context context) {
        this.context=context;
        this.inflater=LayoutInflater.from(context);
    }
    @NonNull
    @Override
    public MsiAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        final View view = inflater.inflate(R.layout.cardviewcomp,parent,false);
        return new MsiAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final MsiAdapter.ViewHolder holder, int position) {
        final ComputerTypeData computerTypeData=DesktopRepo.getInstance().getMsiData().get(position);
    ...
    public int getItemCount() {
        return DesktopRepo.getInstance().getMsiData().size();
    }
